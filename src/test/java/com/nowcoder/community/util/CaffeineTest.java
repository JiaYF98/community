...
public class CaffeineTest {
    ...
    @Test
    void testPostRowsCache() {
        discussPostService.findDiscussPostRows(0);
        discussPostService.findDiscussPostRows(0);
    }

    @Test
    void testPostsCache() {
        discussPostService.findDiscussPostsByUserId(0, 0, 10, 1);
        discussPostService.findDiscussPostsByUserId(0, 0, 10, 1);
        discussPostService.findDiscussPostsByUserId(0, 0, 10, 1);
        discussPostService.findDiscussPostsByUserId(0, 0, 10, 0);
    }
}
